...
class Propguru3Spider(scrapy.Spider):
    name = 'propguru3'
    limit = 0
    num = 0
    single_time = True
    ...
    start_urls = ['https://www.propertiesguru.com/search?viewtype=list&propertytype=sell&cityid=1081&reffid=1&cat=3,28,29,30&bedroom=3&type=ajax&slimit']
    ...
    def parse(self, response):
        ...
        if properties is not None:
            ...
            if (self.limit // 10) != self.num + 1:
                next_url = 'https://propertiesguru.com/search?viewtype=list&propertytype=sell&cityid=1081&reffid=1&cat=3,28,29,30&bedroom=3&type=ajax&slimit=' + str(self.limit)
