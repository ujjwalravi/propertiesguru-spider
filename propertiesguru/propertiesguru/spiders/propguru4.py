...
class Propguru4Spider(scrapy.Spider):
    name = 'propguru4'
    limit = 0
    num = 0
    single_time = True
    ...
    start_urls = ['https://propertiesguru.com/search?viewtype=list&propertytype=sell&cityid=1081&reffid=1&cat=3,28,29,30&bedroom=4&type=ajax&slimit']
